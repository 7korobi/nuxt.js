...
function webpackBaseConfig(name) {
  ...
  var config = {
    ...
    module: {
      ...
      }, { test: /\.css$/, use: this.styleLoader('css') }, { test: /\.less$/, use: this.styleLoader('less', 'less-loader') }, { test: /\.sass$/, use: this.styleLoader('sass', { loader: 'sass-loader', options: { indentedSyntax: true } }) }, { test: /\.scss$/, use: this.styleLoader('scss', 'sass-loader') }, { test: /\.styl(us)?$/, use: this.styleLoader('stylus', 'stylus-loader') }, { test: /\.coffee$/,
        use: {
  ...
  createClass(Builder, [{
    ...
    value: function () {
      var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
        ...
        var templatesFiles, templateVars, layoutsFiles, hasErrorLayout, files, customTemplateFiles, indicatorPath1, indicatorPath2, indicatorPath;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
